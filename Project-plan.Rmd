...
To gruop patients with Minor versus Major Trauma the NISS score was used. Patients with a NISS > 15 were defined as major trauma and those with NISS < 15 were defined as minor trauma. 
...
Out of the `r total.cohort` patients included in the cohort `r all.men` were men. The mean age for all the patients were `r mean.age` years and the avarege NISS score was `r mean.niss`. 
...
Main results
------------
The subgroup with the highest OFI frequency was xxxx with a frequency at `r max.freq`%. The lowest OFI frequency was measured in the xxx cohort with a frquency at `r min.freq`%. Among the men the frequency of OFI was `r freq.ofi.men`% and among the women `r freq.ofi.women`%. In the entire cohort the mean frequency of OFI was `r mean.ofi`%. 

| Cohort       | Frequency of OFI (%)          | Confidence interval  |
|:------------- |:-------------:| -----:|
| Men      | `r freq.ofi.men` | () |
| Women      | `r freq.ofi.women`     |   () |
| Blunt Trauma | `r freq.ofi.blunt`      |    () |
| Pentetraiting Trauma | `r freq.ofi.penetrating` | () |  
| Traffic - motor veichle accident, not motorcycle | `r freq.ofi.traffic1`| () |
| Traffic - motorcycle accident | `r freq.ofi.traffic2` | () |
| Traffic - bicycle accident | `r freq.ofi.traffic3` | () |
| Traffic - pedastrian | `r freq.ofi.traffic4` | () |
| Traffic - other | `r freq.ofi.traffic5` | () |
| Shot by handgun, shotgun, rifle, other firearm of any calibre | `r freq.ofi.shot` | () |
| Stabbed by knife, sword, dagger other pointed or sharp object | `r freq.ofi.stabbed` | () |
| Struck or hit by blunt object | `r freq.ofi.struck` | () |
| Low energy fall - fall in the same level | `r freq.ofi.low.energy` | () |
| High energy fall - fall from a higher level | `r freq.ofi.high.energy` | () |
| Blast injury | `r freq.ofi.blast` | () |
| Other Trauma Mechanism | `r freq.ofi.other` | () |
| Minor Trauma | `r freq.ofi.minor.trauma` | () |
| Major Trauma | `r freq.ofi.major.trauma` | () |
| MSR - Head or Neck | `r freq.ofi.head.neck` | () |
| MSR - Face | `r freq.ofi.face` | () |
| MSR - Chest, Diaphragm or Spine | `r freq.ofi.chest.spine` | () |
| MSR - Abdomen | `r freq.ofi.abdomen` | () |
| MSR - Extremities | `r freq.ofi.extremities` | () |
| MSR - Unspecified | `r freq.ofi.unspecified` | () |
| MSR - Multiple | `r freq.ofi.multiple` | () |
<!--
