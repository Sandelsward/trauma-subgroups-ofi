...
Main results
------------
The subgroup with the highest OFI frequency was xxxx with a frequency at `r max.freq`%. The lowest OFI frequency was measured in the xxx cohort with a frquency at `r min.freq`%. In the entire cohort the mean frequency of OFI was `r mean.ofi`%. 
