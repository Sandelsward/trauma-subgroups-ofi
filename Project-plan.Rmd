...
Out of the `r total.cohort` patients included in the cohort `r all.men` were men.  Among the men the frequency of OFI was `r freq.ofi.men` and among the women `r freq.ofi.women`. The mean age for all the patients were `r mean.age` years and the avarege NISS score was `r mean.niss`. In the entire cohort there was a `r mean.ofi`% frequency of OFI. 
