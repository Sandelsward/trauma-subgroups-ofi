...
Whether there is opportunity for improvement for a specific case or not is decided by a group of experts during M&M where selected trauma casees are reviewed. OFI is defined as when the trauma care for a patient does not match the best practice guidelines in at least one aspect.[@Sanddal2011-cl]
...
The first one is the Trauma registry at the Karolinska 
University Hospital in Solna, which includes about 21000 patients between the 
years 2012 and 2021. 

The second register is the Trauma quality database (TCQD) which is a subset of the trauma registry and includes about 2200 patients selected for review between 2014 and 2021. It holds details and conclusions from M&M. Such details are whether or not there is OFI for a certain case.
