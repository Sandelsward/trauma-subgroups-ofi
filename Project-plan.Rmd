...
Whether there is opportunity for improvement for a specific case or not is decided by a group of experts during a conference where selected trauma case are reviewed. OFI is defined as when the trauma care for a patient does not match the best practice guidelines in at least one aspect.[@Sanddal2011-cl]
