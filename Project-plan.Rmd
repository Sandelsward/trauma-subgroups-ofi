...
It was found that the Abdomen cohort in the subgroup most severely injured body region had the  highest OFI frequency followed by the Major trauma subgroup. It was also found that Men had a higher OFI frequency then women and that penetrating trauma had a higher OFI frequency then blunt trauma. 

A higer OFI frequency in major trauma compared with minor trauma is consistent with previous research. Studies show that preventable deaths increase with the sevreity of the trauma case. The mortality rate is also higher in Major trauma cohort than in Minor trauma. 

Both data from SWETRAU and previous studies show that men are overrepresented in trauma patients. There is also research showing that male trauma patients have a higher frequency of preventable death. eller? 
