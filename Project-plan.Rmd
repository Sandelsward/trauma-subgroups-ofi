...
Introduction: Trauma represents 9% of the annual global deaths and is the most common cause of death in peoplae under the age of 45. This is a heterogeneous group of patients with a large variety of injuries. With this variety comes a complexity that demands specific guidelines for treating all kinds of different trauma subgroups. It is however poorly understood the potental for trauma care improvement varies between subgropus. One measure for this is Opportunity for improvement (OFI).
Aims: In this study we assessed the OFI frequency for the clinically important trauma subgroups; men and women, blund and penetrating trauma, minor and major trauma, and most severely injured body region.
Material and methods: This was a registry based cohort study in which the trauma registry and the trauma quality database at the Karolinska University hospital in Solna was used. A total of 6146 patients added to the registry between 20xx-2021 met the inclusion criteria. 
Results: The men OFI in the total cohort was 7%. It was found that Abdominal trauma had the highest frequency ofi OFI of all subgroups at . In the binary subgroups penatrating trauma and major trauma had the highest OFI. 
Conclusion: Our results suggest that OFI varies between different trauma subgroups and that some subgroups have significantly higer frequency of OFI compared with baseline.
...
Conclusion
-------
Our results suggest that OFI varies between different trauma subgroups and that some subgroups have significantly higer frequency of OFI compared with baseline. Factors like old age and trauma severity was also shown to effect the OFI frequency negatively. 
