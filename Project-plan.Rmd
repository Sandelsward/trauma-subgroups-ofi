...
in Solna, which includes about 11800 patients between the years 2012 and 2021. 

The second registry is the the trauma Quality Database which is a subset of the trauma registry and includes about 6300 patients selected for review between 2014 and 2021. The trauma care quality database includes details and conclusions from the M&M.
...
```{r, echo = FALSE} 
  ofi_selection() ## will be improved later
```
