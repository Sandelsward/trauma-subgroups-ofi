...
Study size 
----------
complete case analysis på min dependent variabel : OFI
och predektiva variabler som NISS...
...
Beskriva i text vad som faktiskt görs. Tex hur frekvens räknas ut.
OCh att jag bara jämför icke överlappande cohorter.
<!-- 
...
Participants
------------
All patients from Karolinska University Hospital trauma registry and from the Trauma Quality Database. To be eligiabel for the study all patients had to meet the inclusion criteria. The criteria were as following: Patients over 15 year old. No missing information in crutial colums in the registries. If information such as gender OFI, trauma mechanism, NISS, or AIS code were missing, the patient was excluded. TA BORT DETTA STYCKE
...
Lyfta fram de mest intressanta siffrorna här när riktiga datan används
