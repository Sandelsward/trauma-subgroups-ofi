...
The study also shows a higher mean age in the OFI chort than in the non OFI cohort. Meaning that the older the patient is the higher is the risk for non optimal trauma care. Darwin et al found that patients between 75-84 years old had a 33% higher odds for preventable death, and thos over 85 years had a 91% higher risk. Previous research has also shown an in increased mortality rate in older trauma patients, which potentially in part could be explained by sub optimal trauma care[1,2]. 

penetrainting/blunt litteratur
