...
<!-- I typically define trauma as the clinical entity composed of physical injury  
and the body's associated response. You can cite my thesis https://openarchive.ki.se/xmlui/handle/10616/44832 -->
...
To further stress the need for more knowledge and research about trauma care<!-- Do you really need this sentence? Consider removing, and start "Some studies indicate..." -->,
...
<!-- I agree, but consider having this before you discuss M&M and audit filters, as they relate more closely to the aim. The closer you get to presenting the aim, the more relevant should the introduction be.-->


Oppotrunity for improvement
------------
<!--Även detta hör hemma i metoden. Titta på Elias och Husseins arbeten. SVAR: Bättre såhär? -->
Whether there is opportunity for improvement for a specific case or not is decided during M&M where selected trauma casees are reviewed. OFI<!-- Note that you haven't used this abbreviation before --> is defined as when the trauma care for a patient does not match the best practice guidelines in at least one aspect.[@Sanddal2011-cl]
...
------------
<!-- See my comment above on the association between distance to the aim and relavance for the aim. This is not relevant to the aim and should therefore be farther away from it. I'm not sure it's relevant at all, at least not as a separate section.-->
...
sufficient understanding of OFIs for different trauma subgroups.[@Coats2020-wj] 
<!-- You haven't mentioned subgroups before, so you might want to introduce these in a separate section first. -->
...
The second register is the Trauma quality database (TCQD)<!-- Try to avoid non-standard abbreviations, as they tend to slow down the reader. Just write trauma care quality database.--> which is a subset of the trauma registry and includes about 2200 patients selected for review between 2014 and 2021. The trauma care quality database includes details and conclusions from the M&M.
...
Setting
-------
The Karolinska University Hospital in Solna, Stockholm, is the leading trauma center in Sweden, and ranked as one of the best hospitals in the world<!-- Provide a source, if you want to include this-->. The hospital is a level 1 trauma center.[@Karolinska] The Trauma department at KUH<!-- I would just remove this abbeviation as well and spell out the full name--> Solna handles about 1800 trauma cases every year, out of which about 200 are children. KUH is the primary trauma center for a population of 2,8 million people.[@Traumanks] 

In Sweden there is a national trauma register (SweTrau) holding records of trauma cases from 48 out of 49 hospitals who recieves major trauma. To meet the inclusions criterias for SweTrau you must be over 15 years of age, been exposed to a traumatic event leading to trauma team activation, or have a NISS over 15 without trauma team activation. [@swetrau]
...
At KUH all trauma patients are included in the KUH trauma register<!-- Use registry-->. The KUH trauma register is a part of the Swedish Trauma Register, with the same eligibility criteria. Audit filters then identify certain trauma cases for whom the care might have deviated from the gold standard treatment based on different criteria. Such criteria are GCS 8 or less but the patient was not intubated, time to CT longer than 20 minutes, time to Surgery and so on. Then a manual selection is done by a nurse, during which some cases are removed from the group of potential OFI cases because obvious reasons for the deviation can be found. The patients who are then left are discussed at a M&M where doctors<!-- Not only doctors, there are nurses as well --> from several specialties participate. At this conference every case is reviewed. Then those patients where OFI is found are marked with "YES" in the OFI colomn in the TCQD and those patient where no OFI is found are mared with "NO"<!-- Not really, OFIs are identified as the actual OFI, like lack of resources, or missed injury, or something like that. We then recode these OFIs into either "Yes, at least one OFI identified" or "No, no OFIs identified".-->.
