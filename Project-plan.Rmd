...
Delta values
------------
The largest delta value was found when comparing the Face and Abdomen cohorts with a delta value of 10,48 ( -1.04 - 12.88 ). The smallest delta value was found in the xxx subgruop with a delta value of ` min delta`. In the xxx subgroup the delta value with the widest range were found ` wid.delta`.
