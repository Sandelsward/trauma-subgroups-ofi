...
Not only does truama represent a large share the global mortality rate, studies 
have shown a significant drifference in outcome depending on where patients are
...
30-day adjusted mortality rate. (2)
...
There are several different systems that is being used in Trauma care. 
...
ATLS is practiced in over 80 countries with and 1 million doctors have gone thru 
this training.  (6). PTC is also used in over 80 counries, however more 
frequently in low and middle income countries. One reason for this could be that 
the PTC program is free while ATLS is not.(7)
