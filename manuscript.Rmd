...
30-day adjusted mortality rate<!--Compared to?-->. [@Candefjord2022-pe] 
...
potentially could have been prevented is as high as 20 to over 50 %. [@Drake2020-kx; @Ray2016-jo; @Ghorbani2018-dh] <!-- Jag skulle lägga till ytterligare meningar här  -->
...
<!-- Du kan absolut prata om ATLS men kanske främst då i din KI uppsats. Då som ett exempel på potentiell utbildningsinsats. Evidensen för ATLS är inte 100%, Martin har bla fått stort anslag för att undersöka detta.
...
trauma ,and across body regions injured. <!--Sant, behöver dock källa. Jag skulle också lägga detta mot slutet i introduktionen för att tydligt kunna knyta ann till ditt aim. -->

Today however, it is poorly understood whether different subgroups have greater 
opportunities for improvement (OFI) than others. Such opportunities for improvement 
could be lack of resources and management errors. <!-- ge vanliga exempel, se exv: 
