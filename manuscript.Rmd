...
Not only does truama represent a large share the global mortality rate, studies have shown a significant drifference in outcome depending on where patients are treated. It has for example been shown that trauma patients in Sweden who were treated at a trauma center rather than a 
...
potentially could have been prevented is as high as 20 to over 50 %. (3, 4, 5)
...
There are several different systems that is being used in Trauma care. Such as Advanced Trauma Life Support (ATLS) and Primary Trauma Care (PTC), where ATLS is the more established system. The purpose of these systems is to secure a time efficient, standardized and structured way of treating trauma patients.(6,7)

ATLS is practiced in over 80 countries with and 1 million doctors have gone thru this training.  (6). PTC is also used in over 80 counries, however more frequently in low and middle income countries. One reason for this could be that the PTC program is free while ATLS is not.(7)
...
<!--Svårt att förstå exakt hur du menar när du först beskriver demografiska subgrupper för att sedan slå ihop det med minskat mortalitet i Sverige? -->

<!--Kan variera ytterligare, här är en studie från KS på delar av ditt material:
https://pubmed-ncbi-nlm-nih-gov.sll.idm.oclc.org/29797712/ -->
