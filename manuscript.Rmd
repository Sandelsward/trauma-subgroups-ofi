...
Over the last decade almost 50 million people world wide have died from trauma.(1)

Since trauma is so multifaceted it is very important to have a good 
understanding of treatment and resources for every different trauma subgroup. 
Such as men and women, blunt and penetrating injury, minor and major trauma and
across body regions injured. It has for example been shown that trauma patients 
in Sweden who were treated at a trauma center rather than a non-trauma center 
have a 41 % lower 30-day adjusted mortality rate. (2)

However it is today poorly understood whether different subgroups have greater 
